...
if __name__ == '__main__':
    ...
    train_nloader = DataLoader(Dataset(args, '../UCF_Train_ten_crop_i3d_new', test_mode=False, is_normal=True),
                               batch_size=args.batch_size, shuffle=True,
                               num_workers=0, pin_memory=False, drop_last=True)
    train_aloader = DataLoader(Dataset(args, '../UCF_Train_ten_crop_i3d_new', test_mode=False, is_normal=False),
                               batch_size=args.batch_size, shuffle=True,
                               num_workers=0, pin_memory=False, drop_last=True)
    test_loader = DataLoader(Dataset(args, '../UCF_Test_one_crop_i3d', test_mode=True),
