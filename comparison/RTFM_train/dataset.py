...
class Dataset(data.Dataset):
    def __init__(self, args, feat_path, is_normal=True, transform=None, test_mode=False):
        ...
        if self.dataset == 'shanghai':
            ...
            if test_mode:
                ...
                self.rgb_list_file = 'list/ucf-i3d-train-1crop.list'
    ...
    def __getitem__(self, index):
        ...
        file_name = osp.join(self.feat_path,  self.list[index].strip().split('\\')[-1])
