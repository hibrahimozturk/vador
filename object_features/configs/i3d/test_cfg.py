...
output_writer = dict(
    clip_folder="../data/object_features/test_5fps/{}/abnormal".format(sub_class),
    json_path="../data/object_features/test_5fps/{}/abnormal_labels_i3d.json".format(sub_class),
    half_precision=True
)
