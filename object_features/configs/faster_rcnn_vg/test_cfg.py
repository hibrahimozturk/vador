...
output_writer = dict(
    clip_folder="../data/object_features/test_5fps_exp/{}/abnormal".format(sub_class),
    json_path="../data/object_features/test_5fps_exp/{}/abnormal_labels.json".format(sub_class),
    half_precision=True
)
